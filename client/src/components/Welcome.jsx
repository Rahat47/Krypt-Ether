                    ...
                    <div className='p-5 sm:w-96 w-full flex-col flex justify-start items-center blue-glassmorphism'>
                        ...
                        {isLoading ? (
                            ...
                            <button
                                ...
                                className='flex flex-row justify-center items-center bg-[#2952e3] rounded-full cursor-pointer hover:bg-[#2546bd] transition-all text-white text-base font-semibold w-full mt-2 border p-2 border-[#3d4f7c]'
                            >
                                <AiFillPayCircle
                                    className='mr-2'
                                    fontSize={21}
