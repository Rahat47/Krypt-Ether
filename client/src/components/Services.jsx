...
const ServiceCard = ({ icon, title, color, subTitle }) => {
    return (
        ...
        <div className='flex w-full justify-center items-center gradient-bg-services'>
            ...
            <div className='flex-1 flex flex-col justify-start items-center'>
                ...
                <ServiceCard
                    ...
                    subTitle='We always maintain privacy and mainting the quality of our products. Security is guaranted.'
                />
                <ServiceCard
                    color='bg-[#f84550]'
